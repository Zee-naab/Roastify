  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'gummi':       '0 8px 32px rgba(0,0,0,0.6), inset 0 1px 0 rgba(255,255,255,0.1)',
        'gummi-hover': '0 20px 60px rgba(0,0,0,0.7), inset 0 1px 0 rgba(255,255,255,0.15)',
        'liquid':      '0 8px 40px rgba(0,0,0,0.5), inset 0 1px 0 rgba(255,255,255,0.05)',
      },
      backgroundImage: {
        'plasma-gradient': 'linear-gradient(135deg, #ff4500, #c0392b, #8a2be2)',
        'card-gradient':   'linear-gradient(145deg, rgba(255,255,255,0.04), rgba(255,255,255,0.01))',
      },
      animation: {
      ...
      keyframes: {
        ...
        plasmaOrb: { '0%,100%': { opacity: '0.15' }, '50%': { opacity: '0.3' } },
        shimmer: {
